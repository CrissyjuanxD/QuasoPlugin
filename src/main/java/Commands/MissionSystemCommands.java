...
public class MissionSystemCommands {
    ...
    public MissionSystemCommands(JavaPlugin plugin, DatabaseManager dbManager, DayHandler dayHandler) {
        this.plugin = plugin;
        this.missionHandler = new MissionHandler(plugin, dbManager, dayHandler);
