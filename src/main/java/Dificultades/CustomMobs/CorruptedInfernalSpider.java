...
public class CorruptedInfernalSpider implements Listener {
    ...
    private final List<SpiderEffect> possibleEffects = Arrays.asList(
            new SpiderEffect("Velocidad", PotionEffectType.SPEED, 2),
            new SpiderEffect("Regeneración", PotionEffectType.REGENERATION, 2),
            new SpiderEffect("Fuerza", PotionEffectType.STRENGTH, 2),
            new SpiderEffect("Salto", PotionEffectType.JUMP_BOOST, 2),
            new SpiderEffect("Brillo", PotionEffectType.GLOWING, 1),
            new SpiderEffect("Caída lenta", PotionEffectType.SLOW_FALLING, 1),
            new SpiderEffect("Resistencia", PotionEffectType.RESISTANCE, 1)
    );
    ...
    private void applyCorruptedInfernalSpiderAttributes(Spider spider) {
        ...
        Objects.requireNonNull(spider.getAttribute(Attribute.ATTACK_DAMAGE)).setBaseValue(3.0);
