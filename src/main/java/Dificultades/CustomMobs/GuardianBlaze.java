...
public class GuardianBlaze implements Listener {
    ...
    public void spawnGuardianBlaze(Location location) {
        ...
        Objects.requireNonNull(blaze.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(40.0);
        blaze.setHealth(40.0);
        Objects.requireNonNull(blaze.getAttribute(Attribute.ATTACK_DAMAGE)).setBaseValue(12.0);
        Objects.requireNonNull(blaze.getAttribute(Attribute.SCALE)).setBaseValue(1.4);
