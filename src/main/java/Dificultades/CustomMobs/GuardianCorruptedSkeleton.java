...
public class GuardianCorruptedSkeleton implements Listener {
    ...
    private void applyGuardianCorruptedSkeletonAttributes(WitherSkeleton skeleton) {
        ...
        Objects.requireNonNull(skeleton.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(25.0);
        skeleton.setHealth(25.0);
        Objects.requireNonNull(skeleton.getAttribute(Attribute.ATTACK_DAMAGE)).setBaseValue(5.0);
