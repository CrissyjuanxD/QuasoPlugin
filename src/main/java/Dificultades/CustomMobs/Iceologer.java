...
public class Iceologer implements Listener {
    ...
    public Evoker spawnIceologer(Location location) {
        ...
        iceologer.getAttribute(Attribute.FOLLOW_RANGE).setBaseValue(32);
        Objects.requireNonNull(iceologer.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(48.0);
    ...
    private void transformToIceAngel(Vex vex) {
        ...
        Objects.requireNonNull(vex.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(20.0);
        vex.setHealth(20.0);
