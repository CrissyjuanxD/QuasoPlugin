...
public class MisionAnimation {
    private final JavaPlugin plugin;
    private static int ongoingAnimations = 0;

    public MisionAnimation(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public synchronized void playAnimation(Player player, String jsonMessage) {
        if (ongoingAnimations == 0) {
            Bukkit.getLogger().info("MisionAnimation empezada para todos los jugadores.");
        }
        ongoingAnimations++;
        ...
        String[] stages = {
                ...
                ChatColor.WHITE + "Mi",
                ChatColor.GRAY + "Mis_",
                ChatColor.WHITE + "Misi",
                ChatColor.GRAY + "Misió_",
                ChatColor.WHITE + "Misión",
                ChatColor.DARK_RED + "\u26a0 " + ChatColor.of("#E96034") + "Misión " + ChatColor.of("#EA8A2B") + "Activada" + ChatColor.DARK_RED + " \u26a0",
        };
        ...
        new BukkitRunnable() {
            ...
            private void showJsonMessageAndFinish() {
                ...
                synchronized (MisionAnimation.this) {
                    if (--ongoingAnimations == 0) {
                        Bukkit.getLogger().info("MisionAnimation finalizada para todos los jugadores.");
                    }
                }
